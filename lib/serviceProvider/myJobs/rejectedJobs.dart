...
class RejectedJobsPage extends StatefulWidget {
  final Function toggleView;
  RejectedJobsPage({this.toggleView});
  @override
  _RejectedJobsPageState createState() => _RejectedJobsPageState();
}

class _RejectedJobsPageState extends State<RejectedJobsPage> {
