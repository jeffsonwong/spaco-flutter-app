...
class AdminCompletedOrdersPage extends StatefulWidget {
  final Function toggleView;
  AdminCompletedOrdersPage({this.toggleView});
  @override
  _AdminCompletedOrdersPageState createState() =>
      _AdminCompletedOrdersPageState();
}

class _AdminCompletedOrdersPageState extends State<AdminCompletedOrdersPage> {
  @override
