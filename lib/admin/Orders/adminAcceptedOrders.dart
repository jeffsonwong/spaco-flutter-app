...
class AdminAcceptedOrdersPage extends StatefulWidget {
  final Function toggleView;
  AdminAcceptedOrdersPage({this.toggleView});
  @override
  _AdminAcceptedOrdersPageState createState() =>
      _AdminAcceptedOrdersPageState();
}

class _AdminAcceptedOrdersPageState extends State<AdminAcceptedOrdersPage> {
  @override
